...
package SAM.Functions is
   ...
   PA27_TCC3_WO6             : constant Peripheral_Function := F;
   PB08_TCC3_WO6             : constant Peripheral_Function := F;
   PA28_TCC3_WO7             : constant Peripheral_Function := F;
   PB09_TCC3_WO7             : constant Peripheral_Function := F;
end SAM.Functions;
