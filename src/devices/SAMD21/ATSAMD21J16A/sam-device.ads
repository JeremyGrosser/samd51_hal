...
package SAM.Device is
   ...
   ADC_Internal : aliased SAM.ADC.ADC_Internal
     with Import, Address => System'To_Address (16#42004000#);

   ADC : aliased SAM.ADC.ADC_Device (ADC_Internal'Access);

   -- PORTA --

   PORTA_Internal : aliased Port_Internal
     with Import, Address => System'To_Address (16#41004400# + 16#000#);
   ...
   PORTB_Internal : aliased Port_Internal
     with Import, Address => System'To_Address (16#41004400# + 16#080#);
   ...
   SERCOM5_Internal : aliased SAM.SERCOM.SERCOM_Internal
     with Import, Address => System'To_Address (16#42001C00#);
